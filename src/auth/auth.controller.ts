import { RegisterDto, UserLoginDto } from 'src/users/dto/create-user.dto';
import {
  Public,
  ResponseMessage,
  SkipInterceptor,
...
export class AuthController {
  ...
  @ResponseMessage('Update user account')
  @Patch('/users/:id')
  updateAccount(@Param('id') id: string, @Body() updateData: any) {
